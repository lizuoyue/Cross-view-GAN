...
class R2DDataLoader(Dataset):
    ...
    def __getitem__(self, idx):
        dir_rgb = self.root_dir + '/' + self.img_id[idx] + '_sate_rgb.jpg'
        ...
        if self.train:      
            dir_label = self.root_dir + '/' + self.img_id[idx] + '_sate_label3.png'
            dir_depth = self.root_dir + '/' + self.img_id[idx] + '_sate_depth.jpg'
...
class RDLRDataLoader(Dataset):
    ...
    def __getitem__(self, idx):
        dir_sate_rgb = self.root_dir + '/' + self.img_id[idx] + '_sate_rgb.png'
